    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url('/assets/dashboard/assets/media/users/300_21.jpg')"></div>
                    ...
                    <a href="#" class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            <span class="navi-icon mr-1">
								<span class="svg-icon svg-icon-lg svg-icon-primary"><!--begin::Svg Icon | path:/assets/dashboard/assets/media/svg/icons/Communication/Mail-notification.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
							<span class="svg-icon svg-icon-md svg-icon-success"><!--begin::Svg Icon | path:/assets/dashboard/assets/media/svg/icons/General/Notification2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <circle fill="#000000" opacity="0.3" cx="18.5" cy="5.5" r="2.5"/>
            ...
            <a href="custom/apps/user/profile-3.html"  class="navi-item">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
 						   <span class="svg-icon svg-icon-md svg-icon-warning"><!--begin::Svg Icon | path:/assets/dashboard/assets/media/svg/icons/Shopping/Chart-bar1.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <rect fill="#000000" opacity="0.3" x="17" y="11" width="3" height="6" rx="1.5"/>
            ...
            <a href="custom/apps/user/profile-2.html"  class="navi-item">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
							<span class="svg-icon svg-icon-md svg-icon-danger"><!--begin::Svg Icon | path:/assets/dashboard/assets/media/svg/icons/Files/Selected-file.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M6.85714286,3 L14.7364114,3 C15.0910962,3 15.4343066,3.12568431 15.7051108,3.35473959 L20.4686994,7.3839416 C20.8056532,7.66894833 21,8.08787823 21,8.52920201 L21,21.0833333 C21,22.8738751 20.9795521,23 19.1428571,23 L6.85714286,23 C5.02044787,23 5,22.8738751 5,21.0833333 L5,4.91666667 C5,3.12612489 5.02044787,3 6.85714286,3 Z M8,12 C7.44771525,12 7,12.4477153 7,13 C7,13.5522847 7.44771525,14 8,14 L15,14 C15.5522847,14 16,13.5522847 16,13 C16,12.4477153 15.5522847,12 15,12 L8,12 Z M8,16 C7.44771525,16 7,16.4477153 7,17 C7,17.5522847 7.44771525,18 8,18 L11,18 C11.5522847,18 12,17.5522847 12,17 C12,16.4477153 11.5522847,16 11,16 L8,16 Z" fill="#000000" fill-rule="nonzero"/>
            ...
            <a href="custom/apps/userprofile-1/overview.html" class="navi-item">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
							<span class="svg-icon svg-icon-md svg-icon-primary"><!--begin::Svg Icon | path:/assets/dashboard/assets/media/svg/icons/Communication/Mail-opened.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <div>
            ...
            <div class="d-flex align-items-center bg-light-warning rounded p-5 gutter-b">
	            <span class="svg-icon svg-icon-warning mr-5">
	                <span class="svg-icon svg-icon-lg"><!--begin::Svg Icon | path:/assets/dashboard/assets/media/svg/icons/Home/Library.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <rect fill="#000000" opacity="0.3" transform="translate(17.825568, 11.945519) rotate(-19.000000) translate(-17.825568, -11.945519) " x="16.3255682" y="2.94551858" width="3" height="18" rx="1"/>
            ...
            <div class="d-flex align-items-center bg-light-success rounded p-5 gutter-b">
	            <span class="svg-icon svg-icon-success mr-5">
	                <span class="svg-icon svg-icon-lg"><!--begin::Svg Icon | path:/assets/dashboard/assets/media/svg/icons/Communication/Write.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path d="M12.9,2 C13.4522847,2 13.9,2.44771525 13.9,3 C13.9,3.55228475 13.4522847,4 12.9,4 L6,4 C4.8954305,4 4,4.8954305 4,6 L4,18 C4,19.1045695 4.8954305,20 6,20 L18,20 C19.1045695,20 20,19.1045695 20,18 L20,13 C20,12.4477153 20.4477153,12 21,12 C21.5522847,12 22,12.4477153 22,13 L22,18 C22,20.209139 20.209139,22 18,22 L6,22 C3.790861,22 2,20.209139 2,18 L2,6 C2,3.790861 3.790861,2 6,2 L12.9,2 Z" fill="#000000" fill-rule="nonzero" opacity="0.3"/>
            ...
            <div class="d-flex align-items-center bg-light-danger rounded p-5 gutter-b">
	            <span class="svg-icon svg-icon-danger mr-5">
	                <span class="svg-icon svg-icon-lg"><!--begin::Svg Icon | path:/assets/dashboard/assets/media/svg/icons/Communication/Group-chat.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <path d="M1.98505595,18 L1.98505595,13 C1.98505595,11.8954305 2.88048645,11 3.98505595,11 L11.9850559,11 C13.0896254,11 13.9850559,11.8954305 13.9850559,13 L13.9850559,18 C13.9850559,19.1045695 13.0896254,20 11.9850559,20 L4.10078614,20 L2.85693427,21.1905292 C2.65744295,21.3814685 2.34093638,21.3745358 2.14999706,21.1750444 C2.06092565,21.0819836 2.01120804,20.958136 2.01120804,20.8293182 L2.01120804,18.32426 C1.99400175,18.2187196 1.98505595,18.1104045 1.98505595,18 Z M6.5,14 C6.22385763,14 6,14.2238576 6,14.5 C6,14.7761424 6.22385763,15 6.5,15 L11.5,15 C11.7761424,15 12,14.7761424 12,14.5 C12,14.2238576 11.7761424,14 11.5,14 L6.5,14 Z M9.5,16 C9.22385763,16 9,16.2238576 9,16.5 C9,16.7761424 9.22385763,17 9.5,17 L11.5,17 C11.7761424,17 12,16.7761424 12,16.5 C12,16.2238576 11.7761424,16 11.5,16 L9.5,16 Z" fill="#000000" opacity="0.3"/>
            ...
            <div class="d-flex align-items-center bg-light-info rounded p-5">
	            <span class="svg-icon svg-icon-info mr-5">
	                <span class="svg-icon svg-icon-lg"><!--begin::Svg Icon | path:/assets/dashboard/assets/media/svg/icons/General/Attachment2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect x="0" y="0" width="24" height="24"/>
        ...
        <div class="offcanvas-wrapper mb-5 scroll-pull">
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="/assets/dashboard/assets/media/stock-600x400/img-1.jpg" title="" alt=""/>
                </a>
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="/assets/dashboard/assets/media/stock-600x400/img-2.jpg" title="" alt=""/>
                </a>
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="/assets/dashboard/assets/media/stock-600x400/img-3.jpg" title="" alt=""/>
                </a>
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="/assets/dashboard/assets/media/stock-600x400/img-4.jpg" title="" alt=""/>
                </a>
            </div>
            <!--end::Item-->
            ...
            <div class="d-flex align-items-center justify-content-between py-8">
                ...
                <a href="#" class="symbol symbol-70 flex-shrink-0">
                    <img src="/assets/dashboard/assets/media/stock-600x400/img-8.jpg" title="" alt=""/>
                </a>
            </div>
            <!--end::Item-->
        </div>
            ...
            <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                ...
                <div class="mb-15">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
							<span class="symbol-label">
								<img src="/assets/dashboard/assets/media/svg/misc/006-plurk.svg" class="h-50 align-self-center" alt=""/>
							</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
							<span class="symbol-label">
								<img src="/assets/dashboard/assets/media/svg/misc/015-telegram.svg" class="h-50 align-self-center" alt=""/>
							</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
							<span class="symbol-label">
								<img src="/assets/dashboard/assets/media/svg/misc/003-puzzle.svg" class="h-50 align-self-center" alt=""/>
							</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap mb-5">
                        <div class="symbol symbol-50 symbol-light mr-5">
							<span class="symbol-label">
								<img src="/assets/dashboard/assets/media/svg/misc/005-bebo.svg" class="h-50 align-self-center" alt=""/>
							</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        <div class="symbol symbol-50 symbol-light mr-5">
							<span class="symbol-label">
								<img src="/assets/dashboard/assets/media/svg/misc/014-kickstarter.svg" class="h-50 align-self-center" alt=""/>
							</span>
                        </div>
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                    ...
                    <div class="text-left flex-grow-1">
                        ...
                        <div class="dropdown dropdown-inline">
                            <button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="svg-icon svg-icon-lg"><!--begin::Svg Icon | path:/assets/dashboard/assets/media/svg/icons/Communication/Add-user.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <polygon points="0 0 24 0 24 24 0 24"/>
                            ...
                            <div class="d-flex flex-column mb-5 align-items-start">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-circle symbol-40 mr-3">
                                        <img alt="Pic" src="/assets/dashboard/assets/media/users/300_12.jpg"/>
                                    </div>
                                    <div>
                            ...
                            <div class="d-flex flex-column mb-5 align-items-end">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-40 ml-3">
                                        <img alt="Pic" src="/assets/dashboard/assets/media/users/300_21.jpg"/>
                                    </div>
                                </div>
...
<div id="kt_scrolltop" class="scrolltop">
	<span class="svg-icon"><!--begin::Svg Icon | path:/assets/dashboard/assets/media/svg/icons/Navigation/Up-2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <polygon points="0 0 24 0 24 24 0 24"/>
        ...
        <div class="offcanvas-wrapper mb-5 scroll-pull">
            <h5 class="font-weight-bold mb-4 text-center">Demo 1</h5><div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo1.png" alt="" class="w-100"/>
                </div>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo2.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo3.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo4.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo5.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo6.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo7.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo8.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo9.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo10.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo11.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo12.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo13.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo14.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo15.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo16.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo17.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo18.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo19.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo20.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo21.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo22.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo23.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo24.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo25.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo26.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo27.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo28.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo29.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
                ...
                <div class="overlay-wrapper rounded-lg">
                    <img src="/assets/dashboard/assets/../../../../../doc//assets/dashboard/assets/img/demos/demo30.png" alt="" class="w-100"/>
                </div>
                <div class="overlay-layer">
                    <a href="#" class="btn font-weight-bold btn-primary btn-shadow disabled" >Coming soon</a>
